      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-6">
        ...
        <header className="text-center space-y-2">
          ...
          <p className="text-sm text-[#c9a959]/70 font-mono">
            Clean the mess. Fix the servers. Try not to lose your mind.
          </p>
        </header>
        ...
        <section className="grid gap-4 md:grid-cols-3">
          <div className="rounded-lg border border-[#3a2618] bg-[#1a1410]/80 p-4 text-sm">
            ...
            <ul className="space-y-1 text-[#8b7355]">
              <li><span className="text-[#66fcf1] font-mono">WASD</span> — Move</li>
              <li><span className="text-[#66fcf1] font-mono">SHIFT</span> — Sprint</li>
              <li><span className="text-[#66fcf1] font-mono">E</span> — Interact</li>
            </ul>
          </div>
          <div className="rounded-lg border border-[#3a2618] bg-[#1a1410]/80 p-4 text-sm">
          ...
          <div className="rounded-lg border border-[#3a2618] bg-[#1a1410]/80 p-4 text-sm">
            ...
            <ul className="space-y-1 text-[#8b7355]">
              <li><span className="inline-block w-3 h-3 bg-[#553322] mr-2 rounded-sm"></span>Trash</li>
              <li><span className="inline-block w-3 h-3 bg-[#445566] mr-2 rounded-sm"></span>Computer</li>
              <li><span className="inline-block w-3 h-3 bg-[#6f4e37] mr-2 rounded-sm"></span>Coffee</li>
              <li><span className="inline-block w-3 h-3 bg-[#222] mr-2 rounded-sm"></span>Server</li>
            </ul>
          </div>
        </section>
      </div>
